...
class _ScreenState extends AbstractState<EmployeeListBloc, EmployeeListNormalView> {
      ...
      body = ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Dismissible(
            ...
            background: Container(color: Provider.of<AppTheme>(context).mainMaterialColor),
    ...
    return PlatformScaffold(
      material: (_, __) => MaterialScaffoldData(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
             var results = await Navigator.pushNamed(context, "/employeeInsertScreen");
             if (results != null) {
               getBloc.add(RetrieveEmployeeListBlocEvent());
             }
          },
  ...
  @override
  BlocWidgetListener<AbstractBlocState> provideBlocListener(BuildContext context) {
    return (context, state) {
        if (state is LoadingState) {
          showDialog(context: context, builder: UiDialogHelper.loadingDialog(context));
        }
