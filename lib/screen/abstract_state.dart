...
abstract class AbstractState<B extends AbstractBloc<AbstractBlocEvent, AbstractBlocState>, W extends StatefulWidget> extends State<W> {
  ...
  BlocWidgetBuilder<AbstractBlocState> provideBlocBuilder(BuildContext buildContext) {
      ...
      child: MultiBlocProvider(
        ...
        child: BlocListener<B, AbstractBlocState>(
          ...
          child: BlocBuilder<B, AbstractBlocState>(
            bloc: _bloc,
            builder: provideBlocBuilder(buildContext)
          )
    )));
  }  
}